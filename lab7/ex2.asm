...
main:
  ...
  addi $10, $zero, 0            #make variable for 0 to compare width to
  
  while:
  
    bne $8, $10, notZero # while width!=0, continue with loop
    beq $8, $10, exit # if width == 0, break out of loop
  ...
  syscall           			# print the string
                             ...
                             # Calculate perimeter
    addi $11, $zero, 2             # put 2 inside a register
    mul $12, $8, $11               # multiply 2 * width
    mul $13, $9, $11               # multiply 2 * height
    add $14, $12, $13             # add values of register 12 & 13 into 14
    
            
                              
   addi $v0, $0, 4             # Print "The perimeter is..." 
